...
namespace LucaSystem.Utils
{
    ...
    class CommandLineUtil
    {
        ...
        [Option("-csv|--format-csv", "Use csv format export and import ,For [scr]", CommandOptionType.NoValue)]
        public bool FormatCsv { get; set; } = false;
                    ...
                    case "scr":
                        ...
                        if (!string.IsNullOrEmpty(CustomOpcodePath))
                        {
                            selclass = new ScriptParser(GameScript.CUSTOM, CustomOpcodePath,
                                FormatOld, FormatLua, FormatLuaE, FormatJson, FormatCsv, OnlyText);
                        }

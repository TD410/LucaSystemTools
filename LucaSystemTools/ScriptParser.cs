...
namespace ProtScript
{
    ...
    public class ScriptParser:AbstractFileParser
    {
        ...
        public override void FileExport(string path, string outpath = null)
        {
            ...
            if(FormatLua || FormatLuaE || FormatJson || FormatCsv)
            {
                ...
                if (FormatCsv)
                {
                    if (outfilepath == null)
                        ...
                        outfilepath += ".csv";
                    if (Path.GetExtension(outfilepath) != ".csv")
                        outfilepath += ".csv";
                    if (outfilepath.EndsWith(".json.csv")) outfilepath = outfilepath.Replace(".json.csv", ".csv");
                    scriptReader.SaveCsv(outfilepath);
                }
                if (OnlyText != null)
                {
